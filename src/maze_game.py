...
def remove_wall_from_list(cell: Tuple[int, int], wall_list: List[Tuple[int,
                                                                       int]]):
...
class MazeGameLayer:
    ...
    def move_left(self):
        ...
        if self.solved == False and curr_loc[1] != 0 and self.board[
    ...
    def move_right(self):
        ...
        if self.solved == False and curr_loc[
    ...
    def move_up(self):
        ...
        if self.solved == False and curr_loc[0] != 0 and self.board[
